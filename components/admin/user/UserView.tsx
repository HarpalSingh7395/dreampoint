...
export default function UserView({
  ...
  const onApprove = (user: User) => setUser(oldUser => ({ ...oldUser, profileStatus: user.profileStatus, } as unknown as User & { documents: Document[] }));
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid gap-4 sm:grid-cols-1 lg:grid-cols-2">
                  {(user.extraQualifications as {
                    title: string,
                    institution: string,
                    year: string,
                  }[]).map((qualification, index: number) => (
            ...
            <CardContent>
              <div className="grid gap-4">
                {user.documents.length > 0 ? (
                  user.documents.map((document: Document) => (
